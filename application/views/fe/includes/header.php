...
<head>
        ...
        <!-- Skin CSS -->
        <link rel="stylesheet" href="<?php echo base_url();?>assets/css/skins/skin-corporate-3.css">
                        ...
                        <div class="header-row">
                            <div class="header-column">
                                <div class="header-logo">
                                    <a href="index.html">
                                        <img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?php echo base_url();?>assets/img/logo.png">
                                    </a>
                                </div>
                            </div>
                            <div class="header-column">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="index-classic.html" data-thumb-preview="<?php echo base_url();?>assets/img/previews/preview-classic.jpg">Classic - Original</a></li>
                                                        <li><a href="index-classic-color.html" data-thumb-preview="<?php echo base_url();?>assets/img/previews/preview-classic-color.jpg">Classic - Color</a></li>
                                                        <li><a href="index-classic-light.html" data-thumb-preview="<?php echo base_url();?>assets/img/previews/preview-classic-light.jpg">Classic - Light</a></li>
                                                        <li><a href="index-classic-video.html" data-thumb-preview="<?php echo base_url();?>assets/img/previews/preview-classic-video.jpg">Classic - Video</a></li>
                                                        <li><a href="index-classic-video-light.html" data-thumb-preview="<?php echo base_url();?>assets/img/previews/preview-classic-video-light.jpg">Classic - Video - Light</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown-submenu">
