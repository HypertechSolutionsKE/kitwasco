...
<head>
        ...
        <!-- Skin CSS -->
        <link rel="stylesheet" href="<?php echo base_url();?>assets/css/skins/skin-corporate-5.css">
                    ...
                    <div class="header-top header-top-secondary header-top-style-3">
                        <div class="container">
                            <p class="text-color-light">
                                <span class="ml-xs"><i class="fa fa-phone"></i> +254-044-4422416 </span><span class="hidden-xs"> | <a href="#">info@kitwasco.co.ke</a></span>
                            </p>
                        ...
                        <div class="header-row">
                            <div class="header-column">
                                <div class="header-logo">
                                    <a href="index.html">
                                        <img alt="Porto" width="100" height="48" src="<?php echo base_url();?>assets/img/logo.png">
                                    </a>
                                </div>
                            </div>
                            <div class="header-column">
